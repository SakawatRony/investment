...
<html lang="en">
  ...
  <head>
    ...
    <!--begin::Fonts-->
    <link rel="stylesheet" href="{{ asset('public/css/fonts.css')}}" integrity="sha256-tXJfXfp6Ewt1ilPzLDtQnJV4hclT9XuaZUKyUvmyr+Q=" crossorigin="anonymous" media="print" onload="this.media='all'"
    />
    <!--end::Fonts-->
    <!--begin::Third Party Plugin(OverlayScrollbars)-->
    <link rel="stylesheet" href="{{ asset('public/css/overlay_scrollbars.css') }}" crossorigin="anonymous"
    />
